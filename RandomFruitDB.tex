...
The part that gives us the most trouble on this side is the communication between the frontend and the backend. The frontend sends requests to the backend but we can't get that request to work to display the results in the browser.
