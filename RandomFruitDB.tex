...
\appendix
 ...
 \begin{enumerate}
  ...
  \end{itemize}
  \begin{enumerate}
   \item Copy file (assuming file fifo.erl is in the local directory)
   ...
   \item[] \texttt{c(``communication.ex'')c(``nodes.ex'')}
   \item Fourth terminal
  ...
  \item[] \texttt{Dispatcher.addFile(“SampleFile1”) Dispatcher.addFile(“SampleFile2”) Dispatcher.lookFile(“SampleFile1”)}
  \end{enumerate}
  \item Clean up
